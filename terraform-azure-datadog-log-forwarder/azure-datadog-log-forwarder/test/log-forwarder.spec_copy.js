describe('log-forwarder', () => {
  ...
  const logForwarder = require('../src/log-forwarder.ts');
  ...
  test('handleJSONArrayLogs: should send with retry for json-string-array type record', async () => {
    // given
    ...
    // when
    await forwarder.handleJSONArrayLogs(logs, 'json-string-array');
  ...
  test('handleJSONArrayLogs: should send messaged with retry for buffer-array type record', async () => {
    // given
    const logs = [
    ...
    // when
    await forwarder.handleJSONArrayLogs(logs, 'buffer-array');
  ...
  test('handleJSONArrayLogs: should send records with retry for buffer-array type record', async () => {
    // given
    const logs = [
      Buffer.from(
        '{\n' +
  ...
  test('handleJSONArrayLogs: check send messages with retry for json-string-array type record', async () => {
    // given
    const logs = ['{"message": "message one"}', '{"message": "message two"}'];
  ...
  test('handleJSONArrayLogs: check send records with retry for json-string-array type record', async () => {
    // given
    const logs = [
      '{\n' +
        '   "records":[\n' +
  ...
  test('handleJSONArrayLogs: should log a warning for buffer-array type record because of not valid json input', async () => {
    // given
    const logs = [
      Buffer.from(
        '{\n' +
  ...
  test('handleJSONArrayLogs: should should log a warning for json-string-array type record because of not valid json input', async () => {
    // given
    const logs = [
      '{\n' +
        '   "records":[\n' +
